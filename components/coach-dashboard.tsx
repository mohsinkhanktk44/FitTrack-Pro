...
import { ArrowUpDown, Check, Copy, ExternalLink, RefreshCw, Shield, Trash2, UserPlus, X, Search, Filter } from "lucide-react"
...
const athletes = [
  ...
  { id: 2, name: "Jane Smith", lastSync: "2023-05-14T09:15:00", stravaConnected: true, notionConnected: false },
  { id: 3, name: "Mike Johnson", lastSync: "2023-05-13T16:45:00", stravaConnected: false, notionConnected: true },
  { id: 4, name: "Sarah Williams", lastSync: "2023-05-12T11:20:00", stravaConnected: true, notionConnected: true },
  { id: 5, name: "Alex Brown", lastSync: "2023-05-11T13:10:00", stravaConnected: false, notionConnected: false },
  { id: 6, name: "Emma Wilson", lastSync: "2023-05-10T08:30:00", stravaConnected: true, notionConnected: true },
  { id: 7, name: "David Lee", lastSync: "2023-05-09T17:45:00", stravaConnected: true, notionConnected: false },
  { id: 8, name: "Lisa Garcia", lastSync: "2023-05-08T12:20:00", stravaConnected: false, notionConnected: true },
  { id: 9, name: "Tom Anderson", lastSync: "2023-05-07T15:10:00", stravaConnected: true, notionConnected: true },
  { id: 10, name: "Kate Miller", lastSync: "2023-05-06T10:45:00", stravaConnected: false, notionConnected: false },
  { id: 11, name: "Chris Davis", lastSync: "2023-05-05T14:30:00", stravaConnected: true, notionConnected: true },
  { id: 12, name: "Amy Taylor", lastSync: "2023-05-04T09:15:00", stravaConnected: true, notionConnected: false },
  { id: 13, name: "James Wilson", lastSync: "2023-05-03T16:45:00", stravaConnected: false, notionConnected: true },
  { id: 14, name: "Rachel Green", lastSync: "2023-05-02T11:20:00", stravaConnected: true, notionConnected: true },
  { id: 15, name: "Mark Thompson", lastSync: "2023-05-01T13:10:00", stravaConnected: false, notionConnected: false },
]
...
export default function CoachDashboard() {
  ...
  const filteredAndSortedAthletes = useMemo(() => {
    let filtered = athletes.filter(athlete => {
      ...
      const matchesFilter = 
        ...
        (connectionFilter === "connected" && athlete.stravaConnected && athlete.notionConnected) ||
        (connectionFilter === "strava-only" && athlete.stravaConnected && !athlete.notionConnected) ||
        (connectionFilter === "notion-only" && !athlete.stravaConnected && athlete.notionConnected) ||
        (connectionFilter === "disconnected" && !athlete.stravaConnected && !athlete.notionConnected)
  ...
  const paginatedAthletes = filteredAndSortedAthletes.slice(startIndex, startIndex + itemsPerPage)
    ...
    <div className="space-y-8">
          ...
          <CardContent className="space-y-4">
            <div className="flex items-center justify-between">
              <span className="flex items-center text-sm font-medium text-gray-700 dark:text-gray-300">
                <svg className="mr-2 h-4 w-4 text-orange-500" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M15.5 15.5L20 20" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
                  <path d="M12 6.5C12 6.5 14.5 9.5 14.5 12C14.5 14.5 12 17.5 12 17.5" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
                  <path d="M8.5 4C8.5 4 4 9 4 12C4 15 8.5 20 8.5 20" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
                </svg>
                Strava
              </span>
              <a href={`https://www.strava.com/oauth/authorize?client_id=${process.env.NEXT_PUBLIC_STRAVA_CLIENT_ID}&response_type=code&redirect_uri=${process.env.NEXT_PUBLIC_STRAVA_REDIRECT_URI}&approval_prompt=auto&scope=read,activity:read`}>
            ...
            <div className="flex items-center justify-between">
              <span className="flex items-center text-sm font-medium text-gray-700 dark:text-gray-300">
                <svg className="mr-2 h-4 w-4 text-gray-600 dark:text-gray-400" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <Card className="border-0 shadow-sm bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-950/20 dark:to-emerald-950/20">
          ...
          <CardContent className="space-y-4">
            <div className="flex items-center justify-between">
              ...
              <span className="font-semibold text-sm text-gray-900 dark:text-gray-100">May 15, 2:30 PM</span>
            </div>
            <div className="flex items-center justify-between">
            ...
            <Button variant="outline" size="sm" className="w-full border-green-200 text-green-700 hover:bg-green-50 dark:border-green-800 dark:text-green-400 dark:hover:bg-green-950/20">
        ...
        <Card className="border-0 shadow-sm bg-gradient-to-br from-purple-50 to-violet-50 dark:from-purple-950/20 dark:to-violet-950/20">
          ...
          <CardContent className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              ...
              <span className="font-semibold text-sm text-gray-900 dark:text-gray-100">Dec 31, 2023</span>
            </div>
            <div className="grid grid-cols-3 gap-1">
              <Button variant="outline" size="sm" className="text-xs border-purple-200 text-purple-700 hover:bg-purple-50 dark:border-purple-800 dark:text-purple-400">Extend</Button>
              <Button variant="outline" size="sm" className="text-xs border-purple-200 text-purple-700 hover:bg-purple-50 dark:border-purple-800 dark:text-purple-400">Change</Button>
              <Button variant="outline" size="sm" className="text-xs border-purple-200 text-purple-700 hover:bg-purple-50 dark:border-purple-800 dark:text-purple-400">Cancel</Button>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="border-0 shadow-sm bg-gradient-to-br from-amber-50 to-orange-50 dark:from-amber-950/20 dark:to-orange-950/20">
          ...
          <CardContent className="space-y-4">
            <div className="flex items-center justify-between">
              ...
              <span className="font-bold text-2xl text-gray-900 dark:text-gray-100">{athletes.length}</span>
            </div>
            <div className="flex items-center justify-between">
              <span className="text-sm font-medium text-gray-600 dark:text-gray-400">Connected:</span>
              <span className="font-bold text-lg text-emerald-600 dark:text-emerald-400">
                {athletes.filter(a => a.stravaConnected && a.notionConnected).length}
              </span>
            </div>
            <div className="flex items-center justify-between">
              <span className="text-sm font-medium text-gray-600 dark:text-gray-400">Synced Today:</span>
              <span className="font-bold text-lg text-blue-600 dark:text-blue-400">3</span>
            </div>
          </CardContent>
        </Card>
      </div>
      ...
      <Card className="border-0 shadow-sm bg-white dark:bg-gray-900">
        <CardHeader className="border-b border-gray-100 dark:border-gray-800 bg-gray-50/50 dark:bg-gray-800/50">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
              <CardTitle className="text-xl font-bold text-gray-900 dark:text-gray-100">Your Athletes</CardTitle>
              <CardDescription className="text-gray-600 dark:text-gray-400 mt-1">Manage your athletes and their connections</CardDescription>
            </div>
            ...
            <Table>
              <TableHeader>
                <TableRow className="hover:bg-transparent border-b border-gray-100 dark:border-gray-800">
                  ...
                  <TableHead className="py-4 font-semibold text-gray-700 dark:text-gray-300">Strava</TableHead>
                  {/* <TableHead className="py-4 font-semibold text-gray-700 dark:text-gray-300">Notion</TableHead> */}
                  <TableHead className="text-right py-4 font-semibold text-gray-700 dark:text-gray-300">Actions</TableHead>
                </TableRow>
              </TableHeader>
              <TableBody>
                {paginatedAthletes.length > 0 ? (
                  paginatedAthletes.map((athlete) => (
                    <TableRow key={athlete.id} className="hover:bg-gray-50 dark:hover:bg-gray-800/30 border-b border-gray-50 dark:border-gray-800/50">
                      <TableCell className="font-semibold text-gray-900 dark:text-gray-100 py-4">{athlete.name}</TableCell>
          ...
          {totalPages > 1 && (
            <div className="flex items-center justify-between p-6 border-t border-gray-100 dark:border-gray-800 bg-gray-50/50 dark:bg-gray-800/50">
              <div className="text-sm text-gray-600 dark:text-gray-400 font-medium">
                Showing {startIndex + 1} to {Math.min(startIndex + itemsPerPage, filteredAndSortedAthletes.length)} of {filteredAndSortedAthletes.length} results
              </div>
                  ...
                  {Array.from({ length: totalPages }, (_, i) => i + 1).map((page) => (
                    <PaginationItem key={page}>
                      <PaginationLink
                        ...
                        className={currentPage === page ? "bg-blue-600 text-white border-blue-600" : "hover:bg-gray-100 dark:hover:bg-gray-800"}
                      >
                        {page}
                      </PaginationLink>
                    </PaginationItem>
      ...
      <Dialog open={inviteDialogOpen} onOpenChange={setInviteDialogOpen}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            <DialogTitle className="text-xl font-bold text-gray-900 dark:text-gray-100">Invite Athlete</DialogTitle>
          ...
          <div className="flex items-center space-x-2">
            <div className="grid flex-1 gap-2">
              <div className="flex items-center border rounded-lg p-3 bg-gray-50 dark:bg-gray-800 border-gray-200 dark:border-gray-700">
                <span className="text-sm truncate flex-1 font-mono text-gray-700 dark:text-gray-300">{inviteLink}</span>
              </div>
            </div>
            <Button
              variant="outline"
              ...
              className={linkCopied ? "text-green-600 border-green-300 bg-green-50 dark:text-green-400 dark:border-green-700 dark:bg-green-950/20" : "border-gray-200 dark:border-gray-700"}
            >
          ...
          <DialogFooter>
            <Button onClick={() => setInviteDialogOpen(false)} className="bg-blue-600 hover:bg-blue-700 text-white">
              Close
            </Button>
          </DialogFooter>
        </DialogContent>
